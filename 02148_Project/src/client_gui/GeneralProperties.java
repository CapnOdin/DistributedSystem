...
public interface GeneralProperties {
	...
	public static Dimension KalenderDimension = new Dimension(frameSizePanel3.width*18/20,frameSizePanel3.height *8/10);
	public static Dimension VagtDimension = new Dimension(frameSizePanel3.width*18/20,25);
	public static Dimension IkonDimension = new Dimension(50,25);
